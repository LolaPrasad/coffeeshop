...
def again1():   
    ...
    Label(root,text="Shop No 11,Kanna Chownk",background="#fff3e6",font=("times", 20)).place(x=510,y=300)
...
def main():
    ...
    def screenshot():
        global w,id
        img = grab(bbox=(0,0,600,650)) #X,Y,X,Y
        w=id
    ...
    L3=Label(f3, text="1.Cappaccino", padx=14,font='Verdana 11',bg='#d8bf6e').pack()
